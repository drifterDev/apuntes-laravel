@extends('template')
@section('content')
    <div class="relative bg-gray-800 px-20 py-16 rounded-lg mb-8 overflow-hidden">
            ...
            @foreach ($posts as $post)
                <a href="" class="bg-gray-100 rounded-lg px-6 py-4">
                    <p class="text-xs flex items-center gap-2">
                        <span class="uppercase text-gray-700 bg-gray-200 rounded-all px-2 py-1">Tutorial</span>
