<div>
    <form class="p-4" wire:submit.prevent='save'>
        <div class="mb-4">
            <input wire:model='task.title' class="p-2 bg-gray-200 w-full" name="title" placeholder="Tarea...">
        </div>
        ...
        <tbody class="text-gray-600">
            @forelse ($tasks as $task)
                <tr class="border-b border-gray-200">
                    <td class="px-4 py-2 w-24 flex justify-center"><input type="checkbox"></td>
